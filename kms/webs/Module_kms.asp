	...
	<head>
		...
		<script>
			...
			function version_show(){
			    ...
			    $j.ajax({
			        url: 'https://raw.githubusercontent.com/shojocon/merlin_kms/master/config.json.js',
			        type: 'GET',
									...
									<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3" class="FormTitle" id="FormTitle">
										<tr>
											<td bgcolor="#4D595D" colspan="3" valign="top">
												<div>&nbsp;</div>
												<div style="float:left;" class="formfonttitle">KMS激活服务 - 来自网络的微软系统工具</div>
												...
												<div class="formfontdesc" id="cmdDesc">该工具用于“激活”“微软OFFICE”和“微软操作系统”。</div>
												...
												<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="kms_table">
													...
													<tr>
														...
														<td colspan="2">
															...
															<a style="margin-left: 318px;" href="https://raw.githubusercontent.com/shojocon/merlin_kms/master/Changelog.txt" target="_blank"><em>[<u> 更新日志 </u>]</em></a>
														</td>
													</tr>
													<tr id="port_tr">
														<th width="35%">外网开关</th>
												...
												<div id="NoteBox">
													...
													<h3>【1】 OFFICE激活</h3>
													<p>CD <font color="red">X</font>:\Program Files<font color="red">(X86)</font>\Microsoft Office\Office<font color="red">19</font>
													</p>
													...
													<h3>【2】 操作系统激活</h3>
													<p>slmgr /ipk <font color="red">M7XTQ-FN8P6-TTKYV-9D4CC-J462D</font>
													</p>
